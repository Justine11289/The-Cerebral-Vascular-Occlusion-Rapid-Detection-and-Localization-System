...
parser.add_argument('--dataset', type=str, default='hdf5_data', help='Input your dataset')
parser.add_argument('--class_num', type=int, default=16, help='Input your class number')
FLAGS = parser.parse_args()

hdf5_data_dir = os.path.join(BASE_DIR, './data/'+FLAGS.dataset)
...
NUM_CATEGORIES = FLAGS.class_num
        ...
        def eval_one_epoch(epoch_num):
            ...
            for i in range(num_test_file):
                ...
                for j in range(num_batch):
                    ...
                    print("test -- loss_val:")
                    print(loss_val)
                    print("test -- label_loss_val:")
                    print(label_loss_val)
                    print("test -- seg_loss_val:")
                    print(seg_loss_val)
                    print("test -- per_instance_label_loss_val:")
                    print(per_instance_label_loss_val)
                    print("test -- per_instance_seg_loss_val:")
                    print(per_instance_seg_loss_val)
                    print("test -- label_pred_val:")
                    print(label_pred_val)
                    print("test -- seg_pred_val:")
                    print(seg_pred_val)
                    print("test -- pred_seg_res:")
                    print(pred_seg_res)'''
                    per_instance_part_acc = np.mean(pred_seg_res == cur_seg[begidx: endidx, ...], axis=1)
                    average_part_acc = np.mean(per_instance_part_acc)
